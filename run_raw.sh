...
g++ -fPIC -c -std=c++11 -fopenmp src/convolution.cpp convolution_wrap.cxx  -I/usr/include/python3.6m -I/home/shahnoor/.local/lib/python3.6/site-packages/numpy/core/include/
