...
/****
 ...
 @param dim_out      : row of the output array
***/
void convolve1d(
...
/****
 ...
 @param thread_count  : number of thread to use
 @param data_out      : output array
 @param dim1_out      : row of the output array
...
/****
 ...
 @param data_out      : output array
 @param dim_out      : row of the output array
 @param threshold    : threshold value to skip following multiplication. detault is 1e-15
***/
...
/****
 ...
 @param dim1_out      : row of the output array
 @param dim2_out      : column of the output array
 @param threshold     : threshold value to skip following multiplication.
                        detault is 1e-15
